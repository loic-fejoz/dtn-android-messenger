...
class PayloadUtilsTest {
    ...
    @Test
    fun testGetPayloadFileExtensionPng(@TempDir tempDir: Path) {
    ...
    @Test
    fun testGetPayloadFileExtensionJpg(@TempDir tempDir: Path) {
    ...
    @Test
    fun testGetPayloadFileExtensionGif(@TempDir tempDir: Path) {
    ...
    @Test
    fun testGetPayloadFileExtensionWebp(@TempDir tempDir: Path) {
